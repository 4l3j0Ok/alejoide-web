...
export const projects = [
  {
    title: "My Links",
    description: "Mi web de links profesionales y personales",
    image: myLinksImage,
    webUrl: "https://links.alejoide.com",
    repoUrl: "https://github.com/4l3j0Ok/my-links-web",
  },
  {
    title: "BCRA Scraper API",
    description: "Una API de código abierto que permite obtener los bancos registrados en el BCRA.",
    image: bcraScraperApiImage,
    webUrl: "https://bcra-scraper-api.alejoide.com",
    repoUrl: "https://github.com/4l3j0Ok/my-links-web",
  },
  {
